...
angular.module('pastac-photos', [])

.component('photosSummary', {
  //scope: {},
  //templateUrl: 'heroDetail.html',
  controller: PastacPhotosSummaryController,
  controllerAs: 'ctrl',
  bindings: {
  ...
  templateUrl: 'assets/vendor/pastac/photos-summary/photos-summary.html'
...
function PastacPhotosSummaryController($scope) {
